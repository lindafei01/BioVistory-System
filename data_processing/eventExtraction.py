...
def ietriple2txt(triple:dict, event_type:str, date:str, origin_sent, file_path):
    with open(file_path, 'a', encoding='utf-8') as f:
        # f.write('subject, relation, object\n')
        for triple_ie in triple.items():
            f.write(triple_ie[0][0]+", "+triple_ie[0][1]+", "+triple_ie[1]+", "
                    +"type:"+event_type+", "+"date:"+date+", "+"origin:"+origin_sent+
                    "\r\n")
    f.close()
...
def process_data(query:str, data):
    name_pattern = {}
    ...
    for sent in resolved_sent_list:
        ...
        ietriple2txt(triple, event_type, date, origin_sent, data_path) 
